...
def get_jalali_update_time():
    ...
    return f"{day_name} {day} {month_name} {year}", time_str
...
def generate_readme():
    ...
    jalali_date_str, time_str = get_jalali_update_time()
...
[![Configs-Count](https://img.shields.io/badge/تعداد%20کانفیگ‌ها-{all_connections_count:,}-blueviolet?style=for-the-badge&logo=server&logoColor=white)](https://github.com/{REPO_OWNER}/{REPO_NAME}/releases/latest/download/{ALL_CONFIGS_FILE})
[![Last-Update](https://img.shields.io/badge/آخرین%20آپدیت-{jalali_date_str.replace("-", " ")}-informational?style=for-the-badge&logo=clock&logoColor=white)](https://github.com/{REPO_OWNER}/{REPO_NAME}/commits/master)
